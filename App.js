...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: '#002f66', paddingHorizontal: 20, paddingTop: 50, paddingBottom: 20, borderBottomLeftRadius: 20, borderBottomRightRadius: 20 },
  headerTitle: { color: 'white', fontSize: 24, fontWeight: 'bold' },
  headerSubtitle: { color: '#d0d0d0', fontSize: 12, marginTop: 4 },
  content: { flex: 1, padding: 16 },
  searchContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: 'white', borderRadius: 30, paddingHorizontal: 16, paddingVertical: 8, marginBottom: 16, elevation: 2 },
  ...
  filterCard: { backgroundColor: 'white', borderRadius: 16, padding: 16, marginBottom: 16, elevation: 2 },
  filterLabel: { fontSize: 13, fontWeight: 'bold', color: '#002f66', marginBottom: 12 },
  filterChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: '#f0f0f0', marginRight: 8 },
  filterChipSelected: { backgroundColor: '#002f66' },
  ...
  switchDesc: { fontSize: 11, color: '#999', marginTop: 2 },
  resultsCount: { fontSize: 12, color: '#666', marginBottom: 12 },
  card: { flexDirection: 'row', backgroundColor: 'white', borderRadius: 16, padding: 12, marginBottom: 12, elevation: 2 },
  avatar: { width: 70, height: 70, borderRadius: 35, marginRight: 12 },
  cardContent: { flex: 1 },
  name: { fontSize: 16, fontWeight: 'bold', color: '#222' },
  jobTitle: { fontSize: 12, color: '#666', marginTop: 2 },
  row: { flexDirection: 'row', marginTop: 4 },
  country: { fontSize: 11, color: '#888', marginRight: 12 },
  salary: { fontSize: 11, color: '#10b981' },
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, alignSelf: 'flex-start', marginTop: 6 },
  returnedBadge: { backgroundColor: '#9C27B0' },
  recruitmentBadge: { backgroundColor: '#002f66' },
  badgeText: { fontSize: 10, fontWeight: 'bold', color: 'white' },
  hireButton: { backgroundColor: '#25d366', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, height: 36, marginTop: 8 },
  hireButtonText: { color: 'white', fontSize: 12, fontWeight: 'bold' },
